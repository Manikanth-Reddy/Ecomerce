...
//				Files.copy(file.getInputStream(), path, StandardCopyOption.REPLACE_EXISTING);
				...
				fileService.saveFile(file, BucketType.CATEGORY.getId());
...
//				Files.copy(file.getInputStream(), path, StandardCopyOption.REPLACE_EXISTING);
	...
	public String saveProduct(@ModelAttribute Product product, @RequestParam("file") MultipartFile image,
		...
		product.setDiscountPrice(product.getPrice() - disocunt);
...
//			Files.copy(image.getInputStream(), path, StandardCopyOption.REPLACE_EXISTING);
			fileService.saveFile(image, BucketType.PRODUCT.getId());
...
//				Files.copy(file.getInputStream(), path, StandardCopyOption.REPLACE_EXISTING);
				...
				fileService.saveFile(file, BucketType.PROFILE.getId());
			}
